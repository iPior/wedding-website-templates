  ...
  return (
    <main className="space-y-10">
      ...
      <div className="space-y-2">
        <p className="text-[10px] uppercase tracking-[0.25em] text-neutral-400">Import from CSV</p>
        <p className="text-[10px] tracking-wide text-neutral-400/60">
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-neutral-200 hover:bg-transparent">
                <TableHead className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-normal">Household</TableHead>
                ...
                <TableHead className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-normal">Primary</TableHead>
                <TableHead className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-normal">RSVP</TableHead>
                <TableHead className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-normal">Dietary</TableHead>
            ...
            <TableBody>
              {households.flatMap((household) =>
                household.guests.map((guest, guestIdx) => (
                  <TableRow key={guest.id} className="border-b border-neutral-200 hover:bg-[#FDFBF7]">
                    <TableCell className="text-sm">
                      {guestIdx === 0 ? (
                        <div className="flex items-center gap-2">
                          <span className="text-neutral-800">{household.name}</span>
                          <span className="text-xs text-neutral-400/60">(+{household.maxPlusOnes})</span>
