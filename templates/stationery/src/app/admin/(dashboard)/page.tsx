...
export default async function AdminDashboardPage() {
  ...
  return (
    <main className="space-y-10">
      <div>
        <p className="text-xs uppercase tracking-[0.3em] text-neutral-400">Overview</p>
        <h1
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="border border-neutral-200 bg-white/60 p-4"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="border border-neutral-200 bg-white/60 p-5">
          <p className="mb-4 text-[10px] uppercase tracking-[0.25em] text-neutral-400">
