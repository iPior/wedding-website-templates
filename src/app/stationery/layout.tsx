...
export default function StationeryLayout({
  ...
  return (
    <div className={`${cormorant.variable} ${lora.variable} min-h-screen bg-[#FDFBF7] text-neutral-800`}>
      <style>{`
        @keyframes fadeIn {
      ...
      <footer className="border-t border-neutral-200/60 bg-[#FAF8F3]">
        <div className="mx-auto max-w-2xl px-6 py-14 text-center">
          <div className="flex items-center justify-center gap-3" style={{ animation: "scaleIn 1.2s ease-out forwards", opacity: 0 }}>
            <div className="h-px w-12 bg-neutral-300/60" />
            <svg width="20" height="20" viewBox="0 0 20 20" className="text-neutral-300">
