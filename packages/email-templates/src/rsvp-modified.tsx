...
const body = { backgroundColor: "#fff8f8", fontFamily: fontBody, margin: "0", padding: "40px 0" };
...
const label = { fontFamily: fontBody, fontSize: "11px", fontWeight: 400 as const, textTransform: "uppercase" as const, letterSpacing: "0.35em", color: "#8a7f7f", margin: "0 0 6px", textAlign: "center" as const };
const mainHeading = { fontFamily: fontDisplay, fontSize: "28px", fontWeight: 400 as const, color: "#2c2424", margin: "0 0 20px", textAlign: "center" as const };
const bodyText = { fontFamily: fontBody, fontSize: "15px", lineHeight: "1.7", color: "#5a4f4f", margin: "0 0 8px" };
const card = { backgroundColor: "#fff8f8", padding: "20px 24px", margin: "24px 0" };
const cardLabel = { fontFamily: fontBody, fontSize: "10px", fontWeight: 700 as const, textTransform: "uppercase" as const, letterSpacing: "0.3em", color: "#8a7f7f", margin: "0" };
const cardDivider = { borderTop: "1px solid #f0e0e4", borderBottom: "none" as const, borderLeft: "none" as const, borderRight: "none" as const, margin: "8px 0 12px" };
const guestRow = { fontFamily: fontBody, fontSize: "14px", lineHeight: "1.5", color: "#2c2424", margin: "6px 0" };
const statusAttending = { color: "#d4a0b0" };
const statusDeclined = { color: "#8a7f7f" };
const divider = { borderTop: "1px solid #f0e0e4", borderBottom: "none" as const, borderLeft: "none" as const, borderRight: "none" as const, margin: "24px 0" };
const button = { backgroundColor: "#2c2424", color: "#fff8f8", fontFamily: fontBody, fontSize: "11px", textTransform: "uppercase" as const, letterSpacing: "0.3em", padding: "14px 32px", textDecoration: "none" };
const closing = { fontFamily: fontDisplay, fontSize: "15px", fontStyle: "italic" as const, color: "#8a7f7f", margin: "28px 0 0", textAlign: "center" as const };
